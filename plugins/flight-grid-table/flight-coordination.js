...
//    },
     ...
     * @returns
     */
    getMarkClearanceStatusZhFull: function (status) {
        var s = parseInt(status, 10);
        var zh = null;
        switch (s) {
            case 0:
     ...
     * @returns
     */
    getPoolStatusZh: function (status) {
        var zh = '';
        if (status == '0') {
            zh = '出池';
        } else if (status == '1') {
     ...
     * @returns
     */
    getMarkNeedSlotZh: function (status) {
        var zh = '';
        if (status == '0') {
            zh = '参加';
        } else if (status == '3') {
     ...
     * 获取资质对应名称
     */
    getMarkQualFlightZh: function( status ){
        var zh = '';
        if (status == '2') {
            zh = '二类飞行';
        }
     ...
     * @param flightid
     */
    isBelongToCarrier: function (flight, carriers) {
     ...
     * @returns {Boolean}
     */
    isInPoolFlight: function (flight) {
     ...
     * @returns {String}
     */
    getConvergenceWaypointName: function (flight) {
        var cw = null;
     ...
     * @returns {String}
     */
    getArrivalConvergenceWaypointName: function (flight) {
     ...
     * @returns {String}
     */
    getArrivalControlInnerWaypointName: function (flight) {
     ...
     * @param flight
     */
    parseMonitorPointInfo: function (flight) {
     ...
     * @param slot
     */
    parseAutoSlotMonitorPointInfo: function (slot) {
        var result = new Object();
     ...
     * @returns {Boolean}
     */
    isUserFocusFlight: function (flight) {
